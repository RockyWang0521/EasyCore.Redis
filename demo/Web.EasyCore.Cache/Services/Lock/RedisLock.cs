...
namespace Web.EasyCore.Cache.Services.Lock
{
    public class RedisLock : IRedisLock
    {
        ...
        {
            await using var context = await _lock.AcquireLockAsync(key, seconds);
        ...
        {
            using var context = _lock.AcquireLock(key, seconds);
        ...
        {
            var context = await _lock.AcquireLockAsync(key, seconds);
        ...
        {
            var context = _lock.AcquireLock(key, seconds);
        ...
        {
            await using var context = await _lock.BlockingLockAsync(key, seconds, blockingSeconds);
        ...
        {
            await using var context = await _lock.BlockingLockAsync(key, seconds, blockingSeconds, renewalSeconds);
